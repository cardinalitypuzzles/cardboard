...
class TestDiscordChatService(TestCase):
    ...
    def test_create_text_channel_creates_parent_category(self):
        ...
        name = "channel-name"
        self.service.create_text_channel(DISCORD_GUILD_ID, name, DISCORD_TEXT_CATEGORY)
    ...
    def test_create_audio_channel_creates_parent_category(self):
        ...
        self.mock_client.guilds_channels_create.return_value = parent
        name = "channel-name"
        self.service.create_audio_channel(
            DISCORD_GUILD_ID, name, DISCORD_VOICE_CATEGORY
        )
        self.mock_client.guilds_channels_create.assert_has_calls(
            [
                # Create parent category channel first.
    ...
    def test_delete_text_channel(self):
        ...
        self.assertEqual(
            self.service.create_text_channel(DISCORD_GUILD_ID, name), channel.id
        )

        self.mock_client.guilds_channels_list.return_value = {channel.id: channel}
        self.service.delete_text_channel(DISCORD_GUILD_ID, channel.id)
    ...
    def test_delete_audio_channel(self):
        ...
        self.mock_client.guilds_channels_create.return_value = channel
        self.assertEqual(
            self.service.create_audio_channel(DISCORD_GUILD_ID, name), channel.id
        )

        self.mock_client.guilds_channels_list.return_value = {channel.id: channel}
        self.service.delete_audio_channel(DISCORD_GUILD_ID, channel.id)
        self.mock_client.channels_delete.assert_called_once_with(channel.id)
    ...
    def test_archive_and_unarchive_channel(self):
        ...
        self.service.archive_channel(
            DISCORD_GUILD_ID, channel.id, DISCORD_ARCHIVE_CATEGORY
        )
        ...
        self.service.unarchive_text_channel(
            DISCORD_GUILD_ID, channel.id, DISCORD_TEXT_CATEGORY
        )
        self.mock_client.channels_modify.assert_has_calls(
            [
    ...
    def test_announce(self):
        self.service.announce(
            DISCORD_PUZZLE_ANNOUNCEMENTS_CHANNEL, "test message", {"text": "text.com"}
        )
        self.mock_client.channels_messages_create.assert_called_once_with(
            DISCORD_PUZZLE_ANNOUNCEMENTS_CHANNEL,
    ...
    def test_create_channel_category_full(self):
        ...
        self.service.create_text_channel(DISCORD_GUILD_ID, "new", DISCORD_TEXT_CATEGORY)
        self.mock_client.guilds_channels_create.assert_called_once_with(
            DISCORD_GUILD_ID,
            ChannelType.GUILD_TEXT,
            "new",
    ...
    def test_archive_channel_category_full(self):
        ...
        self.service.archive_channel(
            DISCORD_GUILD_ID, channel1.id, DISCORD_ARCHIVE_CATEGORY
        )
        self.mock_client.guilds_channels_create.assert_called_once_with(
            DISCORD_GUILD_ID,
            ChannelType.GUILD_CATEGORY,
        ...
        self.mock_client.guilds_channels_list.return_value = channels_list
        self.service.unarchive_text_channel(
            DISCORD_GUILD_ID, archive.id + 1, DISCORD_TEXT_CATEGORY
        )
        ...
        self.service.archive_channel(
            DISCORD_GUILD_ID, channel2.id, DISCORD_ARCHIVE_CATEGORY
        )
    ...
    def test_create_channel_url(self):
        self.assertEqual(
            self.service.create_channel_url(DISCORD_GUILD_ID, 1, is_audio=False),
        ...
        self.assertEqual(
            self.service.create_channel_url(DISCORD_GUILD_ID, 2, is_audio=True),
